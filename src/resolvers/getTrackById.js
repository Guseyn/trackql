...
function getTrackById(_, args, context) {
    return __awaiter(this, void 0, void 0, function () {
        var dbFile, id, db, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    db = _a.sent();
                    return [4 /*yield*/, (0, selectFromDatabase_1.selectFromDatabase)(db, "SELECT * from tracks WHERE id = ".concat(id))];
                case 2:
                    result = _a.sent();
