...
function deleteTrackById(_, args, context) {
    return __awaiter(this, void 0, void 0, function () {
        var dbFile, id, db, deletedTrack;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    db = _a.sent();
                    return [4 /*yield*/, (0, executeInDatabase_1.executeInDatabase)(db, "\n                    DELETE from tracks WHERE id='".concat(id, "'\n                "))];
                case 2:
                    deletedTrack = _a.sent();
                    db.close();
                    if (deletedTrack.changes > 0) {
                        return [2 /*return*/, {
                                status: "Track with id ".concat(id, " Deleted")
                            }];
                    }
